...
// HINT: inside the loop, use querySelector on the current element to find the .recipe-title inside it
...
const dessert = document.querySelector('[data-category="dessert"]').textContent;
console.log(dessert);